...
class Range(Arguments.Argument):
    def __init__(self, start, end, values, file_list, keys_from_metadata_path, name=None, prefix=None, metadata_rules=None):
    ...
    def __deepcopy__(self, memodict={}):
        return Range(self.start, self.end, self.values, self.file_list, self.keys_from_metadata_path, self.name, self.prefix, self.metadata_rules)
